...
<#function generateChapterTitle tableKind rootType>
  <#if tableKind == TABLE.ROOT>
    <#return ('Annotations in root ' + entityToName[rootType])>
  <#elseif tableKind == TABLE.ACTIVE>
    <#return 'Annotations on active substance'>
  <#elseif tableKind == TABLE.NON_ACTIVE>
    <#return 'Annotations on non-active components'>
  <#elseif tableKind == TABLE.DISTANT_DESCENDANTS>
    <#return 'Annotations on other Substances / Mixtures'>
  </#if>
  <#stop 'Unknown table type: ' + tableKind>
</#function>

<#function generateTableTitle tableKind>
  <#if tableKind == TABLE.ROOT>
    <#return 'Annotations on: '>
  <#elseif tableKind == TABLE.ACTIVE>
    <#return 'Annotations on active substance: '>
  <#elseif tableKind == TABLE.NON_ACTIVE>
    <#return 'Annotations on main mixture component: '>
  <#elseif tableKind == TABLE.DISTANT_DESCENDANTS>
    <#return 'Annotations on mixtures in mixtures and their components'>
  </#if>
  <#stop 'Unknown table type: ' + tableKind>
</#function>
  ...
  <#compress>
    <chapter label='${chapterNum}'>
      ...
      <#list entityTablesHash?keys as entityName>
        ...
        <#local tableTitle = generateTableTitle(tableKind) + isSingleton?string('', ' [${entityName}]')>
...
<#macro annotationsLayoutSubstance reportData rootType>
  <book version='5.0' xmlns='http://docbook.org/ns/docbook' xmlns:xi='http://www.w3.org/2001/XInclude'>
    <#list reportData?keys as chapterKey>
      ...
      <@produceChapter chapterHash rootType chapterKey chapterNum=1/>
    </#list>
  </book>
</#macro>
    ...
    <tr>
      <td><?dbfo bgcolor='#D1EEF5' ?>
        ...
        <#if tableKind == TABLE.NON_ACTIVE>
          <#-- FIXME should resolve entityFunction during populating -->
